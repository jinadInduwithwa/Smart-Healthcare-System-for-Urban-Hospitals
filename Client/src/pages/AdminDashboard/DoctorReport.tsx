...
// import { getDoctorAvailabilityReport } from "@/utils/api";
...
//   const maxValue = Math.max(...data.map(item => item.availableSlots));
...
//       console.log("Fetching doctor report with token:", token);
//       const response = await getDoctorAvailabilityReport(token);
//       console.log("API response:", JSON.stringify(response, null, 2));

//       const availableSlots = response?.data?.availableSlots || [];
//       console.log("availableSlots array:", availableSlots);
      
//       if (!Array.isArray(availableSlots)) {
//         console.log("availableSlots is not an array:", availableSlots);
//         toast.error("Invalid data format received from server.");
//         return;
//       }

//       setDoctorData(availableSlots);
//       setIsModalOpen(true);
//       toast.success("Doctor availability report generated successfully!");
//     } catch (error) {
...
//       const averageSlots = Math.round(totalSlots / doctorData.length);
...
//       pdf.text("Specialization", 80, yPosition + 6);
//       pdf.text("Available Slots", 140, yPosition + 6);
...
//         // Truncate long names
//         const doctorName = item.doctorName.length > 20 ? 
//           item.doctorName.substring(0, 20) + "..." : item.doctorName;
//         const specialization = item.specialization && item.specialization.length > 15 ? 
//           item.specialization.substring(0, 15) + "..." : item.specialization || "N/A";
        
//         pdf.text(doctorName, 22, yPosition + 6);
//         pdf.text(specialization, 80, yPosition + 6);
//         pdf.text(item.availableSlots.toString(), 140, yPosition + 6);
...
//                       Y-axis: Number of Available Slots | X-axis: Doctors
//                     </div>
//                   </div>
...
//                         {Math.round(doctorData.reduce((sum, item) => sum + item.availableSlots, 0) / doctorData.length)}
//                       </p>
//                     </div>
//                   </div>
...
//                           <th className="px-4 py-3 border-b text-left text-gray-700 font-semibold">Doctor Name</th>
//                           <th className="px-4 py-3 border-b text-left text-gray-700 font-semibold">Specialization</th>
//                           <th className="px-4 py-3 border-b text-left text-gray-700 font-semibold">Email</th>
//                           <th className="px-4 py-3 border-b text-left text-gray-700 font-semibold">Available Slots</th>
//                         </tr>
//                       </thead>
//                       <tbody>
//                         {doctorData.map((data) => (
//                           <tr key={data.doctorId} className="hover:bg-gray-50 transition-colors">
//                             <td className="px-4 py-3 border-b text-gray-900 font-medium">
//                               {data.doctorName}
//                             </td>
...
//                     <p>Smart Healthcare System - Doctor Availability Report</p>
//                     <p>Page 1 of 1</p>
//                   </div>
//                 </>
//               ) : (
...
//                     No doctor availability data found.
//                   </p>
//                   <p className="text-gray-400 text-sm mt-2">
//                     Please check if doctors have available slots.
//                   </p>
//                 </div>
//               )}
//             </div>
