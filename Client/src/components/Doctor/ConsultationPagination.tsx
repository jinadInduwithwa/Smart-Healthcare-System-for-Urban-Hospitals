...
interface ConsultationPaginationProps {
  ...
  indexOfFirstConsult: number;
  indexOfLastConsult: number;
      ...
      <div className="mb-4 flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <p className="text-gray-600 dark:text-gray-300">
          ...
          <span className="font-medium">
            {Math.min(indexOfLastConsult, totalConsultations)}
          </span>{' '}
          of <span className="font-medium">{totalConsultations}</span> consultations
        </p>
      </div>
