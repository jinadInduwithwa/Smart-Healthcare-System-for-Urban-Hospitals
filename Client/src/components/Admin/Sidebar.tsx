...
const menuItems: MenuItem[] = [
  { path: "/admin-dashboard/overview", title: "Overview", icon: <FiPieChart /> },
  {
    ...
    icon: <FiBook />,
    subItems: [
      { path: "/admin-dashboard/reports/patient", title: "Patient Reports" },
      { path: "/admin-dashboard/reports/doctor", title: "Doctor Reports" },
      { path: "/admin-dashboard/reports/financial", title: "Financial Reports" },
    ],
  },
  {
    ...
    icon: <FiUsers />,
    subItems: [
      { path: "/admin-dashboard/users/doctors", title: "Doctors" },
      { path: "/admin-dashboard/users/patients", title: "Patients" },
    ],
  },
  {
          ...
          <div className="mb-6 p-4 rounded-lg">
            <div className="flex items-center space-x-4">
              <div className="relative">
                <img
                  src="/assets/Home/admin_avatar.jpg"
                  alt="Admin Profile"
